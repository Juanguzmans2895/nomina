                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <select name="estado" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                                ...
                                <option value="procesada" {{ request('estado') == 'procesada' ? 'selected' : '' }}>Procesada (Aplicada)</option>
                                <option value="aplicada" {{ request('estado') == 'aplicada' ? 'selected' : '' }}>Aplicada</option>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <div class="flex items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $totalNovedades ?? 0 }}</p>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <div class="flex items-center">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl font-bold text-yellow-600">{{ $pendientes ?? 0 }}</p>
                        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-300 tracking-wider">Empleado</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-300 tracking-wider">Concepto</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-300 tracking-wider">Fecha</th>
                                <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase dark:text-gray-300 tracking-wider">Cantidad</th>
                                <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase dark:text-gray-300 tracking-wider">Valor</th>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase dark:text-gray-300 tracking-wider">Estado</th>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase dark:text-gray-300 tracking-wider">Acciones</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                    {{ $novedad->fecha?->format('d/m/Y') ?? 'N/A' }}
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    @php
                                        $estadoBadge = match($novedad->estado) {
                                            'pendiente' => ['bg' => 'bg-yellow-100 dark:bg-yellow-900', 'text' => 'text-yellow-800 dark:text-yellow-200', 'label' => 'Pendiente'],
                                            'aprobada' => ['bg' => 'bg-blue-100 dark:bg-blue-900', 'text' => 'text-blue-800 dark:text-blue-200', 'label' => 'Aprobada'],
                                            'aplicada' => ['bg' => 'bg-green-100 dark:bg-green-900', 'text' => 'text-green-800 dark:text-green-200', 'label' => 'Procesada'],
                                            'rechazada' => ['bg' => 'bg-red-100 dark:bg-red-900', 'text' => 'text-red-800 dark:text-red-200', 'label' => 'Rechazada'],
                                            default => ['bg' => 'bg-gray-100', 'text' => 'text-gray-800', 'label' => 'Desconocido'],
                                        };
                                    @endphp
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $estadoBadge['bg'] }} {{ $estadoBadge['text'] }}">
                                        {{ $estadoBadge['label'] }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @else
                                            <a href="#" class="text-gray-400 cursor-not-allowed" title="No editable">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
