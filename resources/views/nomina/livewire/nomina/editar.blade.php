        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-1">{{ $nomina->numero_nomina ?? 'N/A' }}</p>
                </div>
            ...
            <form action="{{ route('nomina.nominas.actualizar', $nomina) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="numero_nomina" value="{{ old('numero_nomina', $nomina->numero_nomina) }}" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600" readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre', $nomina->nombre) }}" required
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg {{ $estadoValue !== 'borrador' ? 'bg-gray-50 dark:bg-gray-700' : 'focus:ring-2 focus:ring-blue-500' }}">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div>
                            ...
                            <input type="text" 
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 font-mono" readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 font-mono font-bold" readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" 
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Notas internas sobre esta nómina</p>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">
                        Detalles por Empleado
                        <span class="text-sm font-normal text-gray-500">({{ count($nomina->detallesNomina) }} empleados)</span>
                    </h2>
                ...
                <div class="space-y-3">
                    ...
                    <div class="border-l-4 border-blue-500 pl-4 py-2">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-sm font-medium text-gray-900">{{ $auditoria->evento }}</p>
                                <p class="text-xs text-gray-600">{{ $auditoria->usuario->name ?? 'Sistema' }}</p>
                            </div>
                        ...
                        @if($auditoria->cambios)
                            <p class="text-xs text-gray-500 mt-1">{{ $auditoria->cambios }}</p>
                        @endif
                    </div>
                    @endforeach
                </div>
