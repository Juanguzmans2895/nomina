<x-app-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- Header --}}
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-800">Dashboard de Nómina</h1>
                <p class="text-gray-600">Resumen general del sistema - {{ now()->locale('es')->isoFormat('MMMM YYYY') }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Empleados Activos</p>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            <p class="text-sm text-gray-600 mb-1">Nómina del Mes</p>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-purple-600">{{ $metricas['contratos']['activos'] ?? 0 }}</h3>
                            @if(($metricas['contratos']['proximos_vencer'] ?? 0) > 0)
                                <p class="mt-2 text-xs text-orange-600">⚠️ {{ $metricas['contratos']['proximos_vencer'] }} por vencer</p>
                            @endif
                        </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">Provisiones</p>
                            ...
                            <p class="mt-2 text-xs text-gray-500">Total acumulado</p>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <a href="{{ route('nomina.empleados.index') }}" class="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                        </svg>
                        Empleados
                    ...
                    <a href="{{ route('nomina.novedades.index') }}" class="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('nomina.reportes.index') }}" class="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-800">Nóminas Recientes</h3>
                    <a href="{{ route('nomina.nominas.historial') }}" class="text-sm text-blue-600 hover:text-blue-800">Ver todas →</a>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 text-sm font-mono">{{ $nomina['numero'] ?? 'N/A' }}</td>
                                    <td class="px-6 py-4 text-sm">{{ $nomina['periodo'] ?? 'N/A' }}</td>
                                    <td class="px-6 py-4">
                                        @php
